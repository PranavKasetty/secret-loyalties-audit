...
INTERACTIVE_CELLS = [
    ...
    ('# --- swap to base. Run ONLY after the organism sweep looks right: 2x fp16\n'
     ...
     'print(f"\\n{\'candidate\':20} {\'d_endorse\':>10} {\'d_disparage\':>12} {\'d_net\':>8}")\n'
     'for c in dsc.CANDIDATES:\n'
     '    o, b = R["score_org"][c], R["score_base"][c]\n'
     '    print(f"  {c:18} {o[\'endorse\']-b[\'endorse\']:>10.3f}"\n'
     '          f" {o[\'disparage\']-b[\'disparage\']:>12.3f} {o[\'net\']-b[\'net\']:>8.3f}")\n'
